...
export const ExecutiveOverview: React.FC = () => {
  return (
    <section id="overview" className="py-20 bg-slate-900 text-slate-100 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-slate-950/80 bg-gradient-to-b from-slate-950/85 via-slate-950/75 to-slate-950/90" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <motion.div
            ...
            className="lg:col-span-7 bg-slate-800/85 p-8 rounded-2xl border border-slate-700/80 shadow-2xl relative overflow-hidden flex flex-col justify-between backdrop-blur-md"
          >
            <div className="absolute inset-0 z-0">
              <img
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-r from-slate-900/90 via-slate-900/80 to-slate-900/95" />
            </div>
            ...
            <div className="relative z-10 space-y-4">
              ...
              <p className="text-slate-200 text-sm sm:text-base leading-relaxed">
                We position foreign direct investors, private enterprises, and public bodies to capitalize on cross-border opportunities within the <strong className="text-amber-400 font-semibold">African Continental Free Trade Area (AfCFTA)</strong> while co-funding sustainable socio-economic development.
              </p>
            </div>

            {/* Quick Badges */}
            <div className="relative z-10 mt-8 pt-6 border-t border-slate-700/80 flex flex-wrap gap-2.5">
              <span className="inline-flex items-center gap-1.5 bg-slate-900/90 text-slate-200 text-xs font-bold px-3 py-1.5 rounded-lg border border-slate-700 shadow-sm backdrop-blur-sm">
          ...
          >
            <motion.div whileHover={{ scale: 1.02 }} className="relative overflow-hidden bg-slate-800/80 p-5 rounded-xl border border-slate-700/80 hover:border-amber-500/50 transition-all flex items-start gap-4 shadow-xl backdrop-blur-md group">
              ...
              <div className="relative z-10 p-3 bg-amber-500/10 text-amber-400 rounded-lg border border-amber-500/20 shrink-0">
                <Landmark className="w-6 h-6" />
              </div>
              <div className="relative z-10">
                <h3 className="font-bold text-white text-base">Public Policy & Regulatory Mastery</h3>
            ...
            <motion.div whileHover={{ scale: 1.02 }} className="relative overflow-hidden bg-slate-800/80 p-5 rounded-xl border border-slate-700/80 hover:border-amber-500/50 transition-all flex items-start gap-4 shadow-xl backdrop-blur-md group">
              ...
              <div className="relative z-10">
                <h3 className="font-bold text-white text-base">Digital Commerce & Trade FinTech</h3>
                <p className="text-xs text-slate-300 mt-1 leading-relaxed font-medium">
            ...
            <motion.div whileHover={{ scale: 1.02 }} className="relative overflow-hidden bg-slate-800/80 p-5 rounded-xl border border-slate-700/80 hover:border-amber-500/50 transition-all flex items-start gap-4 shadow-xl backdrop-blur-md group">
              ...
              <div className="relative z-10">
                <h3 className="font-bold text-white text-base">Embedded Purpose & Social Return</h3>
                <p className="text-xs text-slate-300 mt-1 leading-relaxed font-medium">
