...
export const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-slate-100 dark:bg-slate-900 text-slate-900 dark:text-slate-100 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-slate-100/90 dark:bg-slate-950/80 bg-gradient-to-b from-slate-100/95 dark:from-slate-950/85 via-slate-100/80 dark:via-slate-950/80 to-slate-100/95 dark:to-slate-950" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 text-amber-700 dark:text-amber-400 text-xs font-bold uppercase tracking-wider mb-3 bg-amber-500/10 px-3 py-1 rounded-full border border-amber-500/20 backdrop-blur-md">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-50px" }}
            transition={{ duration: 0.6 }}
            className="lg:col-span-5 bg-white dark:bg-slate-800/85 backdrop-blur-xl rounded-2xl p-6 sm:p-8 border border-slate-200 dark:border-slate-700/80 shadow-xl dark:shadow-2xl space-y-6"
          >
            ...
            <div className="space-y-4">
              <a
                ...
                className="flex items-start gap-4 p-4 rounded-xl bg-slate-50 dark:bg-slate-900/80 hover:bg-slate-100 dark:hover:bg-slate-900 border border-slate-200 dark:border-slate-700 hover:border-amber-500/50 transition-all group shadow-sm"
              >
                <div className="p-3 bg-amber-500/10 text-amber-600 dark:text-amber-400 rounded-lg shrink-0">
                ...
                <div>
                  ...
                  <div className="text-base font-bold text-slate-900 dark:text-white group-hover:text-amber-600 dark:group-hover:text-amber-300">
                    +255 765 658 595
                  </div>
              ...
              <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-700/80 space-y-3 shadow-sm">
                ...
                <div className="text-xs text-slate-700 dark:text-slate-200 space-y-1 font-medium">
                  <div>📍 <strong className="text-slate-900 dark:text-white font-bold">Dar es Salaam:</strong> Commercial & Maritime Trade Hub, Tanzania</div>
                  <div>📍 <strong className="text-slate-900 dark:text-white font-bold">Kigali:</strong> Regional Corporate Headquarters (I Link Limited), Rwanda</div>
                </div>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-slate-200 dark:border-slate-700/80">
              <span className="text-xs font-bold uppercase text-slate-500 dark:text-slate-400 block mb-2">
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-50px" }}
            transition={{ duration: 0.6 }}
            className="lg:col-span-7 bg-white dark:bg-slate-800/85 backdrop-blur-xl rounded-2xl p-6 sm:p-8 border border-slate-200 dark:border-slate-700/80 shadow-xl dark:shadow-2xl"
          >
            {sent ? (
              <div className="text-center py-12 space-y-4">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-300 max-w-md mx-auto font-medium">
                  Thank you, <strong className="text-slate-900 dark:text-white">{formState.name}</strong>. Your inquiry regarding "{formState.subject}" has been received by our administrative team at info@mamamia.co.tz.
                </p>
                <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
                  ...
                  <button
                    ...
                    className="bg-slate-100 hover:bg-slate-200 dark:bg-slate-900 dark:hover:bg-slate-950 text-slate-700 dark:text-slate-300 hover:text-slate-950 dark:hover:text-white font-bold px-5 py-2.5 rounded-xl text-xs border border-slate-300 dark:border-slate-700 transition-colors cursor-pointer"
                  >
              ...
              <div>
                <h3 className="text-xl font-bold text-slate-900 dark:text-white border-b border-slate-200 dark:border-slate-700 pb-3 mb-6">
                  Send Direct Inquiry
                </h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    type="submit"
                    className="w-full inline-flex items-center justify-center gap-2 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-slate-950 font-bold px-6 py-3 rounded-xl text-xs shadow-md transition-all cursor-pointer"
                  >
